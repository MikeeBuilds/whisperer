...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-24 py-5 bg-gradient-to-r from-purple-600 via-blue-500 to-purple-600">
      <h1 className="text-6xl font-sans mb-10 text-white">Echo</h1>
