...
<ul className="list-disc list-inside text-blue-800">
  ...
  <li><span>Real-Time Transcription:</span> Need transcription services in real time? We've got you covered. This service is ideal for live events, webinars, and conferences.</li>
