...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-24 py-5 gradient-bg">
      <h1 className="text-6xl font-sans mb-2 text-white">Echo</h1>
      <p className="text-lg font-sans mb-8 text-white backdrop-blur-sm">Select an audio file and click "Upload" to transcribe the audio to text.</p>
