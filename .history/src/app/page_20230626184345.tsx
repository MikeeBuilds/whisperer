  ...
  return (
    <div>
      ...
      <main className="container mx-auto px-4 sm:px-24 py-5">
        ...
        <section className="flex flex-col items-center bg-gray-700 rounded-xl p-8 backdrop-blur-md bg-opacity-10">
