    ...
    <div>
      ...
      <main className="container mx-auto px-4 sm:px-24 py-5">
        <section className="text-center">
          ...
          <p className="text-sm sm:text-lg font-sans mb-8">Were here to help! If you have any questions about our services or need assistance with our app, please dont hesitate to reach out.</p>
        </section>
